 ...
 *
 * ```php
 * // Create a gateway for the Voucher Gateway
 * // (routes to GatewayFactory::create)
 * $gateway = Omnipay::create('Voucher');
 *
 ...
 * </code>
 *
 * In reality, Voucher Gateway authorize() requests will always be successful and
...
class Gateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Omnipay\Voucher\Message\Request', $parameters);
    }
